Public Class Class_AddKids

    Dim util As New Class_Utils
    Dim htCounter As Integer = 0
    Dim buttonCount As Integer = 0
    Dim currentCatagory As String = "Kids"
    Public buttonDataLinkKids As Hashtable = New Hashtable
    ...
    Public Sub init()
        ...
        htCounter = Nothing
        buttonCount = Nothing
        buttonDataLinkKids = New Hashtable
        ...
        For Each line As String In System.IO.File.ReadLines(util.path & "\" & currentCatagory & ".menu")
            ...
            htCounter += 1
            buttonDataLinkKids.Add(htCounter, values(1)) 'Add the second part of the line to a hashtable, This is used as a data link to link to the inventory database and get the price and other information.
