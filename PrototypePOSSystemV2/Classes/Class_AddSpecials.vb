Public Class Class_AddSpecials

    Dim util As New Class_Utils
    Dim htCounter As Integer = 0
    Dim buttonCount As Integer = 0
    Dim currentCatagory As String = "Specials"
    Public buttonDataLinkSpecials As Hashtable = New Hashtable
    ...
    Public Sub init()
        ...
        htCounter = Nothing
        buttonCount = Nothing
        buttonDataLinkSpecials = New Hashtable
        ...
        For Each line As String In System.IO.File.ReadLines(util.path & "\" & currentCatagory & ".menu")
            ...
            htCounter += 1
            buttonDataLinkSpecials.Add(htCounter, values(1)) 'Add the second part of the line to a hashtable, This is used as a data link to link to the inventory database and get the price and other information.
